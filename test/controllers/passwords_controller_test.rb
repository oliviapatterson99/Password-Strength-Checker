...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference("Password.count") do
      post passwords_url, params: { password: { characters: @password.characters, strong: @password.strong } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { characters: @password.characters, strong: @password.strong } }
